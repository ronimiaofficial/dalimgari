 ...
 *
 * NOTE:
 * Current temporary login system uses sessionStorage.
 * Production authentication should eventually use Supabase Auth
 * with backend/RLS enforced authorization.
 */
...
const DalimgariAdminDashboard = (() => {
  ...
  async function logError(error, context = "admin-dashboard") {
    ...
    try {
      ...
      if (
        dataLayer &&
        typeof dataLayer.logError === "function"
      ) {
      ...
      console.error(
        "Dalimgari error logging failed:",
        loggingError
      );
  ...
  async function logActivity(action, details = {}) {
    ...
    try {
      ...
      if (
        dataLayer &&
        typeof dataLayer.logActivity === "function"
      ) {
      ...
      console.error(
        "Dalimgari activity logging failed:",
        error
      );
  ...
  function checkAdminPermission(permission = "") {
     ...
     *
     * Production version should also
  ...
  async function getSiteDataSafe() {
    ...
    if (
      ...
      throw new Error(
        "Website data সঠিক format-এ পাওয়া যায়নি।"
      );
    }
  ...
  async function saveSiteDataSafe(data) {
    ...
    return await window.saveSiteData(
      data
    );
  }
  ...
  async function getSettingsDataSafe() {
    ...
    if (
      ...
      throw new Error(
        "Settings data সঠিক format-এ পাওয়া যায়নি।"
      );
    }
  ...
  async function saveSettingsDataSafe(data) {
    ...
    if (
      typeof window.saveSettingsData !==
      "function"
    ) {
      throw new Error(
        "saveSettingsData function পাওয়া যায়নি।"
      );
    }

    return await window.saveSettingsData(
      data
    );
  }
  ...
  function updateSnapshots() {
    ...
    state.snapshots.website =
      createWebsiteSnapshot();

    state.snapshots.admin =
      createAdminSnapshot();
  ...
  async function saveWebsiteInformation() {
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          "Website Information সংরক্ষণ করা যায়নি।"
        );
      }
      ...
      showSuccessMessage(
        "Website Information সফলভাবে সংরক্ষণ হয়েছে।"
      );
  ...
  async function saveAdminProfile() {
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          "Admin Profile সংরক্ষণ করা যায়নি।"
        );
      }
      ...
      await logActivity(
        "admin_profile_saved",
        {
          ...
          username:
            newAdmin.login.username,
        }
      );


      showSuccessMessage(
        "Admin Profile সফলভাবে সংরক্ষণ হয়েছে।"
      );
  ...
  function loadManagerProfile() {
    ...
    const manager =
      state.settingsData?.manager ||
      {};

    const permissions =
      state.settingsData?.permissions ||
      {};
  ...
  function validateManagerProfile(
    profile
  ) {
  ...
  async function saveManagerProfile() {
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          "Manager Profile সংরক্ষণ করা যায়নি।"
        );
      }
      ...
      await logActivity(
        "manager_profile_saved",
        {
          ...
          username:
            collected.manager.login.username,
        }
      );


      showSuccessMessage(
        "Manager Profile সফলভাবে সংরক্ষণ হয়েছে।"
      );
  ...
  function normalizeLink(
    ...
    if (
      iconManager &&
      typeof iconManager.normalizeContactLink ===
        "function"
    ) {
      return iconManager.normalizeContactLink(
        rawLink
      );
    }
  ...
  function renderLinks(
    ...
    if (
      ...
      empty.textContent =
        "কোনো Contact Link যোগ করা হয়নি।";
  ...
  function addLink(
    ...
    if (
      ...
      showErrorMessage(
        `সর্বোচ্চ ${MAX_LINKS}টি link রাখা যাবে।`
      );
  ...
  function editLink(
    ...
    if (duplicate) {
      ...
      showErrorMessage(
        "এই URL আগে থেকেই ব্যবহার করা হয়েছে।"
      );
  ...
  function isAllowedContactURL(
    ...
    if (
      iconManager &&
      typeof iconManager.isSupportedContactURL ===
        "function"
    ) {

      return iconManager.isSupportedContactURL(
        url
      );
    }
  ...
  function setupEvents() {
    ...
    const websiteAdd =
      $("addWebsiteLinkButton");


    if (websiteAdd) {

      websiteAdd.addEventListener(
        "click",
        () => {
          addLink(
            "website"
    ...
    const managerAdd =
      $("addManagerLinkButton");


    if (managerAdd) {

      managerAdd.addEventListener(
        "click",
        () => {
          addLink(
            "manager"
  ...
  async function initialize() {
    ...
    /*
     * Authentication must be checked BEFORE
    ...
    try {
      ...
      state.siteData =
        await getSiteDataSafe();


      state.settingsData =
        await getSettingsDataSafe();
