...
async function dalimgariLogout() {
    ...
    try {
        ...
        try {
            ...
            if (
                ...
                window.DalimgariSupabase.auth
            ) {

                await window.DalimgariSupabase
                    .auth
                    .signOut();
...
const DalimgariAPI = {
    ...
    /*
     * Supabase enabled থাকলে সব read/write
     * Supabase-এর সাথে sync হবে, তারপর
     * local merge/validate/normalize pipeline
     * (getSiteData/saveSiteData ইত্যাদি) চলবে
     * যেন কোনো business logic না ভাঙে।
     */
    ...
    _supabase() {
        ...
        return window.DalimgariSupabase || null;
    ...
    async _pullFromSupabase(
        ...
        try {
            ...
            /*
             * Remote data localStorage cache-এ বসিয়ে
             * দেওয়া হচ্ছে, যাতে existing normalize/
             * migrate pipeline অপরিবর্তিত থাকে।
             */
...
window.DalimgariDataLayer = {
    ...
    getSiteData:
        () => DalimgariAPI.getSite(),

    saveSiteData:
        (siteData) => DalimgariAPI.saveSite(siteData),


    getSettingsData:
        () => DalimgariAPI.getSettings(),

    saveSettingsData:
        (settingsData) => DalimgariAPI.saveSettings(settingsData),
